const PrevIcon = ({size}) => {
    return (
        <svg fill="currentColor" height={size} width={size} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
const NextIcon = ({size}) => {
    return (
        <svg
        fill="currentColor" height={size} width={size} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
